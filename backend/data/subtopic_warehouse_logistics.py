    ...
    "dialogues": [
        {
            ...
            "lines": [
                {"speaker": "Driver", "swissGerman": "Morge! Ich ha do en Lieferig für d'Firma Weber.", "german": "Morgen! Ich habe hier eine Lieferung für die Firma Weber.", "english": "Morning! I have a delivery for Weber company."},
                {"speaker": "You", "swissGerman": "Morge! Ja, das sind mir. Wie viel Palette händ Sie?", "german": "Morgen! Ja, das sind wir. Wie viele Paletten haben Sie?", "english": "Morning! Yes, that's us. How many pallets do you have?"},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "Colleague", "swissGerman": "Hey, weisch du wo die Chischte mit de Schrube sind?", "german": "Hey, weißt du wo die Kisten mit den Schrauben sind?", "english": "Hey, do you know where the boxes with screws are?"},
                {"speaker": "You", "swissGerman": "Ja, Gang 4, Regal B. Drütti Reiä vo obe.", "german": "Ja, Gang 4, Regal B. Dritte Reihe von oben.", "english": "Yes, aisle 4, shelf B. Third row from the top."},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "Manager", "swissGerman": "So, hüt isch Inventur. Mir müend alles zelle und mit em System vergliiche.", "german": "So, heute ist Inventur. Wir müssen alles zählen und mit dem System vergleichen.", "english": "So, today is inventory. We need to count everything and compare with the system."},
                {"speaker": "You", "swissGerman": "Okay. Letschts Mal hämmer e Differänz gha bi de Elektroartikel.", "german": "Okay. Letztes Mal hatten wir eine Differenz bei den Elektroartikeln.", "english": "Okay. Last time we had a discrepancy with the electronics."},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Ich muess die schwäre Palette uf de oberi Ebeni stelle. Chan ich de Gabelstapler näh?", "german": "Ich muss die schweren Paletten auf die obere Ebene stellen. Kann ich den Gabelstapler nehmen?", "english": "I need to put the heavy pallets on the upper level. Can I use the forklift?"},
                {"speaker": "Manager", "swissGerman": "Ja, aber pass uf! D'Palette dörf nöd über 800 Kilo si.", "german": "Ja, aber pass auf! Die Paletten dürfen nicht über 800 Kilo sein.", "english": "Yes, but be careful! The pallets must not be over 800 kilos."},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Ich ha d'Bstellig 4521 fertig packt. Wo muess de Lieferschiin dra?", "german": "Ich habe Bestellung 4521 fertig gepackt. Wo muss der Lieferschein dran?", "english": "I've finished packing order 4521. Where does the delivery slip go?"},
                {"speaker": "Colleague", "swissGerman": "Immer usse uf de Karton chlebe. Und s'Fragile-Label nöd vergässe!", "german": "Immer außen auf den Karton kleben. Und das Fragile-Label nicht vergessen!", "english": "Always stick it on the outside of the box. And don't forget the fragile label!"},
