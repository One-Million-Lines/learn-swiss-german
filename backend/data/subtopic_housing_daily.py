    ...
    "dialogues": [
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Grüezi, ich bi de Mieter vo de Wohnig in de Bergstrass 12.", "german": "Guten Tag, ich bin der Mieter der Wohnung in der Bergstraße 12.", "english": "Hello, I'm the tenant of the apartment at Bergstrasse 12."},
                {"speaker": "Manager", "swissGerman": "Grüezi! Was isch s'Problem?", "german": "Guten Tag! Was ist das Problem?", "english": "Hello! What's the problem?"},
                {"speaker": "You", "swissGerman": "D'Heizig funktioniert nümm. Es isch huuchalt i de Wohnig.", "german": "Die Heizung funktioniert nicht mehr. Es ist eiskalt in der Wohnung.", "english": "The heating doesn't work anymore. It's freezing cold in the apartment."},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Hoi! Häsch du de Zettel im Treppehuus gseh?", "german": "Hallo! Hast du den Zettel im Treppenhaus gesehen?", "english": "Hi! Did you see the notice in the stairwell?"},
                {"speaker": "Neighbor", "swissGerman": "Ja! S'Wasser wird morn abgstellt vo Nüüni bis Zwölfi.", "german": "Ja! Das Wasser wird morgen abgestellt von neun bis zwölf.", "english": "Yes! The water will be shut off tomorrow from nine to twelve."},
                {"speaker": "You", "swissGerman": "Ah, drum! Und was steit no uf em Zettel? Ich ha nöd alles verstande.", "german": "Ah, deshalb! Und was steht noch auf dem Zettel? Ich habe nicht alles verstanden.", "english": "Ah, that's why! And what else does the notice say? I didn't understand everything."},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Hoi, entschuldigung — isch s'möglich d'Musig chli liiser z'mache?", "german": "Hallo, Entschuldigung — ist es möglich die Musik etwas leiser zu machen?", "english": "Hi, sorry — is it possible to turn the music down a bit?"},
                {"speaker": "Neighbor", "swissGerman": "Oh, isch es z'luut? Sorry, mir merked das nöd immer.", "german": "Oh, ist es zu laut? Sorry, wir merken das nicht immer.", "english": "Oh, is it too loud? Sorry, we don't always notice."},
                {"speaker": "You", "swissGerman": "S'isch scho nach Zäni und ich muess morn schaffe.", "german": "Es ist schon nach zehn und ich muss morgen arbeiten.", "english": "It's already past ten and I have to work tomorrow."},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Entschuldigung, wänn isch mini Wöschziit?", "german": "Entschuldigung, wann ist meine Waschzeit?", "english": "Excuse me, when is my laundry time?"},
                {"speaker": "Neighbor", "swissGerman": "Lueg am Wöschplan. De hängt a de Wand i de Wöschchuchi.", "german": "Schau auf den Waschplan. Der hängt an der Wand in der Waschküche.", "english": "Check the laundry schedule. It's on the wall in the laundry room."},
                {"speaker": "You", "swissGerman": "Ah okay. Und darf ich am Sunntig wösche?", "german": "Ah okay. Und darf ich am Sonntag waschen?", "english": "Ah okay. And am I allowed to do laundry on Sunday?"},
        ...
        },
        {
            ...
            "lines": [
                {"speaker": "You", "swissGerman": "Grüezi! Ich bi nöi do. Ich bi letscht Wuche iizoge.", "german": "Guten Tag! Ich bin neu hier. Ich bin letzte Woche eingezogen.", "english": "Hello! I'm new here. I moved in last week."},
                {"speaker": "Neighbor", "swissGerman": "Grüezi! Wilkomme! Ich bi d'Frau Steiner, vo de Wohnig nebedraa.", "german": "Guten Tag! Willkommen! Ich bin Frau Steiner, von der Wohnung nebenan.", "english": "Hello! Welcome! I'm Mrs. Steiner, from the apartment next door."},
                {"speaker": "You", "swissGerman": "Fröit mich! Ich ha no es paar Frage wäge de Husornig.", "german": "Freut mich! Ich habe noch ein paar Fragen wegen der Hausordnung.", "english": "Nice to meet you! I have a few questions about the house rules."},
